...
const entrada1 = +prompt("Ingrese la cantidad de entradas general")
const entrada2 = +prompt("Ingrese la cantidad de entradas para mayores")
...
const entradas = (entradaGeneral,entradaMayores,entradaMenores) => {
  ...
  main.innerText=`
  El monto de las entradas general es : $/.${generalTotal}
  El monto de las entradas para mayores de 65 es : $/.${mayoresTotal}
